---
title: "<br>Data Visualization with R Shiny<br>ODSC East 2019"
...
On the day of the tutorial, please have RStudio, your preferred internet browser, and [all provided tutorial files (linked here)](https://github.com/acolum/conference-presentations/tree/master/ODSC%20EAST%202019){target="_blank"} open and ready.
...
Together, we're going to learn how to build [this R Shiny application](https://acolumbus.shinyapps.io/OSCON_ShinyApp/){target="_blank"} with essential components and features including:
...
To build this app, we're going to use a dataset pulled directly from an [open NASA data repository!](https://data.nasa.gov/Space-Science/Fireball-And-Bolide-Reports/mc52-syum){target="_blank"} This dataset is a chronological summary of 500 fireball sightings from April 2003 to January 2018. 
...
**Note:** More information about interactive `plotly` graphics in R can be found in [Carson Sievert's free online book](https://plotly-r.com/){target="_blank"}.
...
More information about reactlogs can be found in the [RStudio Documentation](https://shiny.rstudio.com/reference/shiny/1.1.0/showReactLog.html){target="_blank"}.
...
You can add icons to your tabs from [Fontawesome](https://fontawesome.com/icons?d=gallery){target="_blank"} and [Glyphicons](http://glyphicons.com/){target="_blank"}. Note that since our tabPanels are not within a navbarPage, we can't do this in our app today, but to add an icon, you would simply type:
...
Shinythemes customize the overall theme and look of a Shiny app. [Refer to RStudio's documentation for more information.](https://rstudio.github.io/shinythemes/){target="_blank"}
...
[RStudio Connect](https://www.rstudio.com/products/connect/){target="_blank"} is an enterprise publishing platform for the work teams create in R and Python. If your company (like my company, Pacific Life) has a contract here, you can host R Shiny applications, R Markdown reports, Jupyter Notebooks, and more on one convenient, private server.

## Shiny in Style! - Additional Features of R Shiny

- **Shiny in RMarkdown:** You can include Shiny inputs and outputs in an RMarkdown document! This means that your RMarkdown document can be interactive. See [Shiny Interactive Elements in RMarkdown](https://bookdown.org/yihui/rmarkdown/shiny-documents.html){target="_blank"} for more information.

- **Shiny Dashboards:** You can build a Shiny dashboard in a very similar fashion to the app we built today. See the documentation for the [dashboard packages below](#shiny-dashboards){target="_blank"} for more information.
...
- [Shiny Cheatsheet](https://shiny.rstudio.com/images/shiny-cheatsheet.pdf){target="_blank"}

- <https://shiny.rstudio.com>{target="_blank"}

- [RStudio Shiny Webinars](https://www.rstudio.com/resources/webinars/#shinyessentials){target="_blank"}

- [Awesome R Shiny Tutorials and Resources](https://github.com/grabear/awesome-rshiny){target="_blank"}

### Appearance and Layout

- [Application Layout Guide](https://shiny.rstudio.com/articles/layout-guide.html){target="_blank"}

- [Shiny Loading Animations](https://github.com/andrewsali/shinycssloaders){target="_blank"}

- [More Shiny Loading Animations](https://github.com/emitanaka/shinycustomloader){target="_blank"}

- [HTML Templates](https://shiny.rstudio.com/articles/templates.html){target="_blank"}

- [Integrating React.js and Shiny](https://resources.rstudio.com/shiny/integrating-react-js-and-shiny){target="_blank"}

### Deployment and Hosting

- [Hosting Shiny Apps on Your Own Server](http://www.kimberlycoffey.com/blog/2016/2/13/mlz90wjw0k76446xkg262prvjp0l8u){target="_blank"}

- [Hosting Shiny Apps on an AWS EC2 Instance](https://towardsdatascience.com/how-to-host-a-r-shiny-app-on-aws-cloud-in-7-simple-steps-5595e7885722){target="_blank"}

### Production 

- [Shiny in Production](https://github.com/kellobri/spc-app){target="_blank"}

- [Building Big Shiny Apps](https://rtask.thinkr.fr/blog/building-big-shiny-apps-a-workflow-1/){target="_blank"}

- [Make Shiny fast by doing as little work as possible](https://www.rstudio.com/resources/videos/make-shiny-fast-by-doing-as-little-work-as-possible/){target="_blank"}

- [Plot Caching](https://blog.rstudio.com/2018/11/13/shiny-1-2-0/){target="_blank"}

- [Scoping Rules for Shiny Apps](http://shiny.rstudio.com/articles/scoping.html){target="_blank"}

### Utilities

- [Modularizing Shiny App Code](https://shiny.rstudio.com/articles/modules.html){target="_blank"}

- [Effective Use of Shiny Modules](https://rpodcast.github.io/rsconf-2019/#1){target="_blank"}

- [Bookmarking State](https://shiny.rstudio.com/articles/bookmarking-state.html){target="_blank"}

- [Bookmarking and Modules](https://shiny.rstudio.com/articles/bookmarking-modules.html){target="_blank"}

- [Advanced Bookmarking](https://shiny.rstudio.com/articles/advanced-bookmarking.html){target="_blank"}

- [Shiny Interactive Elements in RMarkdown](https://bookdown.org/yihui/rmarkdown/shiny-documents.html){target="_blank"}

- [How Shiny's Reactivity Works](http://shiny.rstudio.com/articles/execution-scheduling.html){target="_blank"}

### Testing and Error Messages

- [Debugging Shiny Applications](https://shiny.rstudio.com/articles/debugging.html){target="_blank"}

- [Reactlog 2.0 - Debugging the State of Shiny](https://github.com/schloerke/presentation-2019-01-18-reactlog){target="_blank"}

- [Testing Shiny Applications with `shinytest`](https://shiny.rstudio.com/articles/shinytest.html){target="_blank"}

- [Sanitizing Error Messages](https://shiny.rstudio.com/articles/sanitize-errors.html){target="_blank"}
...
### And many more! Explore them here: <http://gallery.htmlwidgets.org>{target="_blank"}
